 ...
 * @author Freddy
 */
public class SendMail_Maintenance {
    public static void sendMail(String receveursList,String object,String corps) {
        ...
        String MonEmail = "walid.benothman@esprit.tn";
        String password = "tgtgtgxd97*";
        ...
        try {
            ...
            Logger.getLogger(SendMail_Maintenance.class.getName()).log(Level.SEVERE, null, ex);
        }
